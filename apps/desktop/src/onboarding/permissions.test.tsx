...
describe("PermissionsSection", () => {
  ...
  it("collects Accessibility permission on macOS", () => {
    ...
    expect(screen.getByText("Help Nixo listen to you")).toBeTruthy();
    expect(screen.getByText("Help Nixo listen to others")).toBeTruthy();
    expect(screen.getByText("Help Nixo read meeting activity")).toBeTruthy();
    expect(
      screen
  ...
  it("preserves the audio-only flow outside macOS", () => {
    ...
    expect(screen.queryByText("Help Nixo read meeting activity")).toBeNull();
  ...
  it("routes an assisted Accessibility pane to the guided flow", () => {
    ...
    expect(row.getAttribute("title")).toBe(
      "Opens System Settings and guides you to add Nixo to the Accessibility list",
    );
