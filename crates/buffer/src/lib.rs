...
fn transform_mentions_in_markdown(markdown: &str) -> String {
    ...
    re.replace_all(markdown, |caps: &regex::Captures| {
        ...
        format!(
            r#"<a class="mention" data-mention="true" data-id="{}" data-type="{}" data-label="{}" href="javascript:void(0)" onclick="event.preventDefault(); if (window.__ANARLOG_NAVIGATE__) window.__ANARLOG_NAVIGATE__('{}');">@{}</a>"#,
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Nixo: Enhanced Meeting Notes

# Objective: Introduce Nixo as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Nixo through X and Discord.
